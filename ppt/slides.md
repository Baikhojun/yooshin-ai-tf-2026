...
<img src="/icebreaker-fish.jpg" class="rounded-xl shadow-lg w-full" />
<div class="text-xs text-center opacity-60">A 사물 (이름은 마지막에)</div>

<img src="/icebreaker-bridge.jpg" class="rounded-xl shadow-lg w-full" />
<div class="text-xs text-center opacity-60">B 사물 (이름은 마지막에)</div>
...
- **사진 업로드 ❌**, 본인 글로만 설명 ✅
- 8분 — A·B 중 마음에 드는 쪽 *하나만* 골라 도전

## 진행

1. 사진을 보고 떠오르는 단어 두 개씩만 적어요
...
👉 같은 사진이라도 <span class="text-blue-500 font-bold">설명(맥락)이 달라지면</span> AI의 추측이 달라져요 — 상품은 없어요 😄
</div>
