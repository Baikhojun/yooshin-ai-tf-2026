...
<div class="slide-sub">**15분 · 다 같이**</div>
...
1. **법인카드 50건** 복사<br>
   <a href="https://raw.githubusercontent.com/Baikhojun/yooshin-ai-tf-2026/main/demo-data/%EB%B2%95%EC%9D%B8%EC%B9%B4%EB%93%9C_50%EA%B1%B4.txt" target="_blank" class="text-blue-500 underline text-xs">📄 데이터 열기</a>
2. **맥락 없이** 새 대화에 붙여넣기
3. **역할 + 형식** 추가 후 재시도
4. **두 결과 비교**
...
<div class="mt-2 text-xs opacity-80">→ 마지막 3분 공유</div>
...
💡 같은 데이터 — **무엇을 어떻게 묻느냐**로 결과가 달라집니다 (1교시 핵심)
</div>
...
<div class="grid grid-cols-2 gap-3 mt-1 items-start text-sm">
...
<div class="slide-banner mt-2 bg-yellow-50 dark:bg-yellow-900 border border-yellow-400">
