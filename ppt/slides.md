...
| ☕ | 13:50 ~ 14:00 | 휴식 10분 | — |
| **2교시** | 14:00 ~ 14:50 | AI가 단어를 분류하는 방식 · **의미공간** + 매번 잊는 **작업기억** + 인터뷰 프롬프트 | "AI는 단어를 별자리로 보고, 매일 첫 출근하는 신입사원처럼 매번 잊어요" |
| ☕ | 14:50 ~ 15:00 | 휴식 10분 | — |
...
<div class="grid grid-cols-[1.4fr_1fr] gap-6 mt-3 items-center">

<div>
<img src="/icebreaker-fish.jpg" class="rounded-xl shadow-2xl w-full" />
</div>
...
<div class="mt-4 p-3 bg-gray-100 dark:bg-gray-800 rounded text-base opacity-80">
예시 입력:<br>
*"파란, 바다 — 이게 뭘까요?"*<br>
*"외계 생물, 무지개 — 이게 뭘까요?"*
</div>
...
<div>
<img src="/icebreaker-bridge.jpg" class="rounded-xl shadow-2xl w-full" />
</div>
...
<span class="text-2xl">**15분 · 다 같이**</span>
...
1. 아래 **법인카드 50건** 데이터를 통째로 복사
   <a href="https://raw.githubusercontent.com/Baikhojun/yooshin-ai-tf-2026/main/demo-data/%EB%B2%95%EC%9D%B8%EC%B9%B4%EB%93%9C_50%EA%B1%B4.txt" target="_blank" class="text-blue-500 underline text-sm">📄 데이터 열기 (새 탭)</a>

2. **맥락 없이** AI에 그냥 붙여넣기<br>
   <span class="text-sm opacity-70">→ AI가 뭐라고 답하는지 확인</span>

3. **역할 + 출력 형식**을 같이 줘서 다시 시도<br>
   <span class="text-sm opacity-70">예: "당신은 경리 담당자입니다. 위 데이터를 부서·항목별로 표로 정리해 주세요"</span>
...
💡 같은 데이터인데도 **무엇을 어떻게 묻느냐**로 결과가 완전히 달라집니다 — 이게 오늘 1교시의 핵심
</div>
...
<span class="text-2xl">**10분 · 1인 1대화창**</span>
...
답변을 들으면 다음 질문으로 넘어가세요.

10번 질문이 끝나면
"인터뷰 정리표"를 마크다운 표로 만들어 주세요.
```
...
<div class="mt-5 p-3 bg-green-50 dark:bg-green-900 rounded text-sm">
💡 **왜 이 실습이 중요한가?**<br>
AI에게 **거꾸로 질문받는 경험** —<br>
사람은 "무엇을 자동화할지" 막연한데,<br>
**AI가 물어보면** 정리됩니다.
</div>

<div class="mt-3 text-xs opacity-70">
⏰ 시간 안 되면 5번 질문만 받아도 OK
</div>
...
실습 ②에서 받은 **인터뷰 정리표**를 텍스트 파일로 저장<br>
<span class="text-sm opacity-80">→ 2회차에서 흐름도(Mermaid) 그릴 재료가 됩니다</span>
