...
사내 결재용 회의록에 **그대로 붙여넣을** 수준

<div class="mt-2 text-sm opacity-80">
→ 이 전체를 MD 파일로 저장하면 다음 회의 때 **메모만 갈아 끼우면** 됩니다
</div>
...
<div class="text-xl mb-3 opacity-90">**15분 · 다 같이**</div>
...
1. **법인카드 50건** 데이터 통째로 복사<br>
   <a href="https://raw.githubusercontent.com/Baikhojun/yooshin-ai-tf-2026/main/demo-data/%EB%B2%95%EC%9D%B8%EC%B9%B4%EB%93%9C_50%EA%B1%B4.txt" target="_blank" class="text-blue-500 underline">📄 데이터 열기 (새 탭)</a>

2. ChatGPT **새 대화** → 데이터만 붙여넣기<br>
   <span class="text-sm opacity-80">→ AI가 뭐라고 답하는지 확인</span>

3. **역할 + 출력 형식** 추가 후 다시 시도<br>
   <span class="text-sm opacity-80">예: "당신은 경리 담당자입니다. 부서·항목별 표로 정리해 주세요"</span>

4. **두 결과를 나란히 비교** — 어디가 달라졌나요?
...
💡 같은 데이터인데 **무엇을 어떻게 묻느냐**로 결과가 완전히 달라집니다 — 1교시 핵심
</div>

<div class="mt-2 text-sm opacity-70">→ 마지막 3분, 한두 분 공유</div>
...
<div class="text-xl mb-2 opacity-90">**10분 · 1인 1대화창**</div>

<div class="grid grid-cols-2 gap-4">

<div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-800 text-base">

## ① 진행 순서

1. ChatGPT 또는 Gemini **새 대화창** 열기

2. **`homework-interviewer-prompt.md`** 전체 복사·붙여넣기<br>
   <a href="https://raw.githubusercontent.com/Baikhojun/yooshin-ai-tf-2026/main/demo-data/homework-interviewer-prompt.md" target="_blank" class="text-blue-500 underline text-sm">📄 프롬프트 파일 열기 (새 탭)</a>

3. AI가 **한 번에 질문 1개**씩 → 솔직하게 답하기

4. AI가 **인터뷰 노트**를 실시간 정리 → 확인 후 다음 질문

5. 끝나면 **업무 맥락 문서** (A~E 영역) 받기

<div class="mt-2 p-2 bg-blue-50 dark:bg-blue-900 rounded text-sm">
**AI가 물어볼 것**: 부서·역할 → 반복 업무 → 쓰는 도구 → 병목·지루한 일 → 자동화 후보
</div>

</div>

<div class="p-3 rounded-lg border border-gray-200 dark:border-gray-600 text-base">

## ② 끝나면 손에 남는 것

- **인터뷰 노트** (대화 중 AI가 정리)
- **업무 맥락 문서** — A1~E3 구조 (A4 2페이지 분량 목표)
- 3교시 MD 프롬프트의 **씨앗 재료**

<div class="mt-2 text-sm opacity-90 font-mono bg-gray-100 dark:bg-gray-900 p-2 rounded leading-snug">
A 역할·책임 / B 일상 업무<br>
C 문제·병목 / D 도구·프로세스 / E 기타
</div>

<div class="mt-2 p-2 bg-green-50 dark:bg-green-900 rounded text-sm">
💡 **거꾸로 질문받는 경험** — "뭘 자동화할지" 막연한데, AI가 물어보면 정리됩니다
</div>

<div class="mt-1 text-xs opacity-70">⏰ 시간 부족 시 5~7번 질문만 받아도 OK</div>
...
<div class="text-base">
교육생분 PC 어딘가에 **조용히 잠들어 있다가**,<br>
일이 생기면 **깨워서** 쓰는 텍스트 파일입니다.
</div>

<div class="mt-3 p-3 bg-blue-50 dark:bg-blue-900 rounded-lg text-base flex-1">

**한 번 만들어 두면**:

1. `회의록_정리.md` (또는 본인 파일) **전체 복사**
2. ChatGPT **새 대화**에 붙여넣기
3. `[데이터]` 아래에 **오늘 메모만** 추가 → Enter
4. 🎉 **매번 새로 프롬프트 쓰는 번거로움 0**

</div>

</div>

<div class="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg font-mono text-sm leading-relaxed">
...
<div class="mt-3 p-2 rounded-lg bg-yellow-50 dark:bg-yellow-900 border-2 border-yellow-400 text-center text-base">
✨ 이것이 <span class="font-bold">본 1회차 교육의 핵심 산출물</span> — 오늘 실습 ④에서 **업무 1 + 개인 1** 만듭니다
</div>
...
<div v-click class="mt-3 p-2 bg-green-50 dark:bg-green-900 border-l-4 border-green-500 rounded text-center text-base font-bold">
...
🎤 AI를 **인터뷰어**로 바꿔, 본인 머릿속의 업무 지식을 끌어내는 기술
...
<span class="text-2xl">**15분 · 1인 2파일**</span>

<div class="grid grid-cols-2 gap-5 mt-3">

<div class="p-4 rounded-lg bg-blue-50 dark:bg-blue-900 border-l-4 border-blue-500">

## 🏢 업무용 MD 1개

본인 부서의 **반복 업무** 1가지를<br>MD 프롬프트로 작성
...
💡 다음 주 월요일에 **그대로 다시 쓸** 것을 만든다는 마음으로
</div>

</div>

<div class="p-4 rounded-lg bg-pink-50 dark:bg-pink-900 border-l-4 border-pink-500">

## 🏠 개인용 MD 1개

본인의 **일상 반복** 1가지를<br>MD 프롬프트로 작성
...
<div v-click class="mt-4 p-3 bg-yellow-50 dark:bg-yellow-900 rounded text-base text-center">
🚀 오늘 끝나면 본인 폴더에 <span class="font-bold">MD 파일 2개</span>가 쌓입니다 — 본 교육의 첫 자산
</div>
...
<span class="text-sm opacity-70">그 그림에서 **이번에 도구로 만들 한 부분**을 골라냅니다.</span>
</div>
