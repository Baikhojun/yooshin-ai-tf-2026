...
❌ **RPA 외주 발주** — 외부 자동화 용역 발주는 별도 채널입니다.
...
| 교시 | 시간 | 큰 주제 | 한 줄 |
|:---:|:---:|:---|:---|
| **1교시** | 0:00~0:50 | 오리엔테이션 + **Pillar 1 자동완성** | "AI는 *다음 단어를 찍는 점쟁이*" |
| ☕ | 0:50~1:00 | 휴식 10분 | — |
| **2교시** | 1:00~1:50 | **Pillar 2 의미공간** + **Pillar 3 작업기억** | "AI는 *별자리*로 보고, *신입사원*처럼 매일 잊는다" |
| ☕ | 1:50~2:00 | 휴식 10분 | — |
| **3교시 ⭐** | 2:00~2:50 | **MD 프롬프트 파일** + 인터뷰 + 자동화 후보 | "내 업무를 *MD로 박아두면* 다음에도 그대로 쓸 수 있다" |
| 마무리 | 2:50~3:00 | 정리·과제·예고·Q&A | — |
...
오늘은 노트북을 <span class="text-yellow-400 font-bold">꺼내두고</span>,<br>
손에 <span class="text-yellow-400 font-bold">마우스를 쥔 채로</span> 들으세요.

</div>

<div class="mt-12 text-lg opacity-80">
강사가 시연하는 동안 <span class="font-bold">위원도 같이 클릭</span>해 보는 것이<br>
가장 빠른 학습입니다. 가만히 듣기만 하면 *내일 출근하면 다 잊습니다*.
</div>
...
<!--
강사 노트:
- 사무실 사물 추천 (클립보드, 도장통, 결재판)
- "어떤 단어가 정답을 끌어냈는가" 강조
- 자연 연결: "이걸 우리는 '맥락(context)'이라고 부릅니다"
-->
...
💡 *위원에게 한 마디*: "여기서 <span class="text-blue-500 font-bold">맥락을 한 줄만</span> 더 주면 답이 어떻게 바뀔까요?"
</div>
...
<div class="text-base opacity-80 mb-4">위원이 자주 빠지는 함정 №1</div>
...
⚠️ 위원의 70%는 *2단계*에서 *맥락*을 빼먹습니다. 오늘 그 습관을 고치는 게 목표.
</div>
...
<div class="mt-8 text-center text-lg">
📸 이 한 장의 표가 1회차에서 <span class="text-blue-500 font-bold">위원이 가져가는 가장 큰 인사이트</span>
</div>
...
지금까지의 MD 프롬프트는 <span class="font-bold">위원 → AI</span> 방향.<br>
...
**인터뷰 프롬프트는 *방향이 반대*** —<br>
*"당신이 인터뷰어다, 나에게 질문해라"* → AI가 **위원에게 질문**
...
|----------------|---------------------|
| 위원 → 데이터 → AI → 결과 | AI 질문 ↔ 위원 답 ↔ AI 다음 질문 … |
| **1턴** (한 방에) | **여러 턴** 대화 |
